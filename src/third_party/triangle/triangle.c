...
#define BADTRIPERBLOCK                                                         \
    4092 /* Number of skinny triangles allocated at once.                      \
          */
...
#define encode(otri)                                                           \
    (triangle)((unsigned long long)(otri).tri |                                \
               (unsigned long long)(otri).orient)
...
#define uninfect(otri)                                                         \
    (otri).tri[6] = (triangle)((unsigned long long)(otri).tri[6] &             \
...
#define sencode(osub)                                                          \
    (subseg)((unsigned long long)(osub).ss |                                   \
             (unsigned long long)(osub).ssorient)
    ...
    if (b->weighted && (b->poly || b->quality)) {
        ...
        if (!b->quiet) {
            printf("Warning:  weighted triangulations (-w, -W) are "
                   "incompatible\n");
            printf("  with PSLGs (-p) and meshing (-q, -a, -u).  Weights "
                   "ignored.\n");
        }
    }
...
void printsubseg(struct mesh* m, struct behavior* b, struct osub* s)
{
    ...
    if (printvertex == (vertex)NULL)
        ...
        printf("    Segment origin[%d] = x%lx  (%.12g, %.12g)\n",
               4 + s->ssorient, (unsigned long long)printvertex, printvertex[0],
               printvertex[1]);
    ...
    if (printvertex == (vertex)NULL)
        ...
        printf("    Segment dest  [%d] = x%lx  (%.12g, %.12g)\n",
               5 - s->ssorient, (unsigned long long)printvertex, printvertex[0],
               printvertex[1]);
}
              ...
              int                alignment)
{
    ...
    pool->firstblock =
        (int**)trimalloc(pool->itemsfirstblock * pool->itembytes +
...
float incircleadapt(vertex pa, vertex pb, vertex pc, vertex pd, float permanent)
{
    ...
    float axtbct[16], aytbct[16], bxtcat[16], bytcat[16], cxtabt[16],
        cytabt[16];
                    ...
                    float  permanent)
{
    ...
    if (adxtail != 0.0) {
        if (bdytail != 0.0) {
            ...
            Two_One_Product(adxt_bdyt1, adxt_bdyt0, cdheight, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
            ...
            finother = finswap;
            if (cdheighttail != 0.0) {
                Two_One_Product(adxt_bdyt1, adxt_bdyt0, cdheighttail, u3, u[2],
                                u[1], u[0]);
                u[3]      = u3;
        ...
        if (cdytail != 0.0) {
            ...
            Two_One_Product(adxt_cdyt1, adxt_cdyt0, bdheight, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
                fast_expansion_sum_zeroelim(finlength, finnow, 4, u, finother);
            ...
            finother = finswap;
            if (bdheighttail != 0.0) {
                Two_One_Product(adxt_cdyt1, adxt_cdyt0, bdheighttail, u3, u[2],
                                u[1], u[0]);
                u[3]      = u3;
                finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                        finother);
    ...
    if (bdxtail != 0.0) {
        if (cdytail != 0.0) {
            ...
            Two_One_Product(bdxt_cdyt1, bdxt_cdyt0, adheight, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
                fast_expansion_sum_zeroelim(finlength, finnow, 4, u, finother);
            ...
            finother = finswap;
            if (adheighttail != 0.0) {
                Two_One_Product(bdxt_cdyt1, bdxt_cdyt0, adheighttail, u3, u[2],
                                u[1], u[0]);
                u[3]      = u3;
                finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                        finother);
        ...
        if (adytail != 0.0) {
            ...
            Two_One_Product(bdxt_adyt1, bdxt_adyt0, cdheight, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
                fast_expansion_sum_zeroelim(finlength, finnow, 4, u, finother);
            ...
            finother = finswap;
            if (cdheighttail != 0.0) {
                Two_One_Product(bdxt_adyt1, bdxt_adyt0, cdheighttail, u3, u[2],
                                u[1], u[0]);
                u[3]      = u3;
                finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                        finother);
    ...
    if (cdxtail != 0.0) {
        if (adytail != 0.0) {
            ...
            Two_One_Product(cdxt_adyt1, cdxt_adyt0, bdheight, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
                fast_expansion_sum_zeroelim(finlength, finnow, 4, u, finother);
            ...
            finother = finswap;
            if (bdheighttail != 0.0) {
                Two_One_Product(cdxt_adyt1, cdxt_adyt0, bdheighttail, u3, u[2],
                                u[1], u[0]);
                u[3]      = u3;
                finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                        finother);
        ...
        if (bdytail != 0.0) {
            ...
            Two_One_Product(cdxt_bdyt1, cdxt_bdyt0, adheight, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
                fast_expansion_sum_zeroelim(finlength, finnow, 4, u, finother);
            ...
            finother = finswap;
            if (adheighttail != 0.0) {
                Two_One_Product(cdxt_bdyt1, cdxt_bdyt0, adheighttail, u3, u[2],
                                u[1], u[0]);
                u[3]      = u3;
                finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                        finother);
    ...
    if (m->recenttri.tri != (triangle*)NULL) {
        if (!deadtri(m->recenttri.tri)) {
            ...
            if (dist < searchdist) {
                ...
                searchdist = dist;
                if (b->verbose > 2) {
                    printf("    Choosing recent triangle with origin (%.12g, "
                           "%.12g).\n",
                           torg[0], torg[1]);
                }
            }
        ...
        do {
            ...
            if (!deadtri(sampletri.tri)) {
                ...
                if (dist < searchdist) {
                    ...
                    searchdist = dist;
                    if (b->verbose > 2) {
                        printf("    Choosing triangle with origin (%.12g, "
                               "%.12g).\n",
                               torg[0], torg[1]);
                    }
                }
        ...
        if (doflip) {
            ...
            if (top.tri == m->dummytri) {
                ...
                if ((leftvertex == m->infvertex1) ||
                     ...
                     * should */
                    /*   be applied. */
                    doflip = counterclockwise(m, b, newvertex, rightvertex,
                                              farvertex) > 0.0;
                }
                     ...
                     * should */
                    /*   be applied. */
                    doflip = counterclockwise(m, b, farvertex, leftvertex,
                                              newvertex) > 0.0;
                }
...
long delaunay(struct mesh* m, struct behavior* b)
{
    ...
    if (!b->quiet) {
        printf("Constructing Delaunay triangulation by divide-and-conquer "
               "method.\n");
    }
        ...
        if ((farvertex[0] == endpoint2[0]) && (farvertex[1] == endpoint2[1])) {
            ...
            if (area == 0.0) {
                ...
                if (crosssubseg.ss == m->dummysub) {
                    ...
                    collision = 1;
                    /* Insert a vertex at the intersection. */
                    segmentintersection(m, b, &fixuptri, &crosssubseg,
                                        endpoint2);
                    done = 1;
                }
            }
    ...
    if (b->poly) {
        ...
        for (i = 0; i < m->insegments; i++) {
            ...
            if ((end1 < b->firstnumber) ||
                ...
                if (!b->quiet) {
                    printf("Warning:  Invalid first endpoint of segment %d in "
                           "%s.\n",
                ...
                if (!b->quiet) {
                    printf("Warning:  Invalid second endpoint of segment %d in "
                           "%s.\n",
                           b->firstnumber + i, polyfilename);
                }
            }
                ...
                if ((endpoint1[0] == endpoint2[0]) &&
                    ...
                    if (!b->quiet) {
                        printf("Warning:  Endpoints of segment %d are "
                               "coincident in %s.\n",
                               b->firstnumber + i, polyfilename);
                    }
                }
                ...
                int              regions)
{
    ...
    if (regions > 0) {
        if (!b->quiet) {
            if (b->regionattrib) {
                if (b->vararea) {
                    printf("Spreading regional attributes and area "
                           "constraints.\n");
                }
                else {
        ...
        for (triangleloop.orient = 0; triangleloop.orient < 3;
            ...
            if ((triangleloop.tri < trisym.tri) ||
                ...
                if (trisym.tri == m->dummytri) {
                    ...
                    /* Find the number of the adjacent triangle (and Voronoi
                     * vertex). */
                    p2 = *(int*)(trisym.tri + 6);
