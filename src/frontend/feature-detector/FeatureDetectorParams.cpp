...
void SubPixelCornerFinderParams::print() const
{
    ...
    PipelineParams::print(
        out, "Termination criteria type", term_criteria_.type,
        "Termination criteria maximum iters", term_criteria_.maxCount,
        "Termination criteria epsilon", term_criteria_.epsilon, "Window size",
        window_size_, "Zero zone", zero_zone_);
    LOG(INFO) << out.str();
}
...
void FeatureDetectorParams::print() const
{
    ...
    PipelineParams::print(
        out,
        "Feature Detector Type: ", VIO::to_underlying(feature_detector_type_),
        "Max features per frame", max_features_per_frame_,
        "Enable Subpixel corner refinement", enable_subpixel_corner_refinement_,
        "Enable Non-maximum suppression", enable_non_max_suppression_,
        ...
        "quality_level_: ", quality_level_, "block_size_: ", block_size_,
        "use_harris_corner_detector", use_harris_corner_detector_, "k_: ", k_,
        "Fast Threshold", fast_thresh_);
    LOG(INFO) << out.str();
