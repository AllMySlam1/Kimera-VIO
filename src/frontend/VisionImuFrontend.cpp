...
VisionImuFrontend::VisionImuFrontend(const ImuParams& imu_params,
                                     ...
                                     bool             log_output)
    : frontend_state_(FrontendState::Bootstrap), frame_count_(0),
      keyframe_count_(0), last_keyframe_timestamp_(0), imu_frontend_(nullptr),
      tracker_(nullptr), tracker_status_summary_(),
      display_queue_(display_queue), logger_(nullptr)
{
...
VisionImuFrontend::spinOnce(FrontendInputPacketBase::UniquePtr&& input)
{
    ...
    TrackingStatusPose* status_pose_mono)
{
    ...
    if (tracker_->tracker_params_.ransac_use_2point_mono_ &&
        ...
        // 2-point RANSAC.
        // TODO(marcus): move things from tracker here, only ransac in
        // tracker.cpp
        *status_pose_mono =
