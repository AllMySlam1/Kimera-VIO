...
void FrontendParams::print() const
{
    ...
    PipelineParams::print(
        out,
        // Tracker params
        "klt_win_size_: ", klt_win_size_, "klt_max_iter_: ", klt_max_iter_,
        "klt_max_level_: ", klt_max_level_, "klt_eps_: ", klt_eps_,
        "maxFeatureAge_: ", maxFeatureAge_, "Optical Flow Predictor Type",
        VIO::to_underlying(optical_flow_predictor_type_),
        // RANSAC params
        "useRANSAC_: ", useRANSAC_, "minNrMonoInliers_: ", minNrMonoInliers_,
...
bool FrontendParams::parseYAML(const std::string& filepath)
{
    ...
    yaml_parser.getYamlParam("intra_keyframe_time",
                             &intra_keyframe_time_seconds);
    ...
    switch (optical_flow_predictor_type) {
        ...
        case VIO::to_underlying(OpticalFlowPredictorType::kRotational): {
            optical_flow_predictor_type_ =
                OpticalFlowPredictorType::kRotational;
            break;
        }
        default: {
...
bool FrontendParams::equals(const FrontendParams& tp2, double tol) const
{
    return (klt_win_size_ == tp2.klt_win_size_) &&
           ...
           // STEREO parameters:
           (fabs(intra_keyframe_time_ns_ - tp2.intra_keyframe_time_ns_) <=
            tol) &&
