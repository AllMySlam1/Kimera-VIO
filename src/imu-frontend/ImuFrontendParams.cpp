...
bool ImuParams::parseYAML(const std::string& filepath)
{
    ...
    yaml_parser.getYamlParam("imu_preintegration_type",
                             &imu_preintegration_type);
    ...
    LOG_IF(FATAL, !body_Pose_cam.equals(gtsam::Pose3::identity()))
        << "parseImuData: we expected identity body_Pose_cam_: is everything "
           "ok?";
    ...
    yaml_parser.getYamlParam("accelerometer_noise_density",
                             &acc_noise_density_);
...
void ImuParams::print() const
{
    ...
    PipelineParams::print(out, "gyroscope_noise_density: ", gyro_noise_density_,
                          "gyroscope_random_walk: ", gyro_random_walk_,
                          "accelerometer_noise_density: ", acc_noise_density_,
                          "accelerometer_random_walk: ", acc_random_walk_,
                          "imu_integration_sigma: ", imu_integration_sigma_,
                          "imu_time_shift: ", imu_time_shift_,
