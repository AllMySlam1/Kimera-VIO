...
bool RegularVioBackendParams::equals(const BackendParams& vp2, double tol) const
{
...
RegularVioBackendParams::safeCast(const BackendParams& params)
{
    try {
        ...
        LOG(FATAL)
            << "Exception caught when casting to RegularVioBackendParams.";
    }
}
