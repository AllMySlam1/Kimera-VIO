    ...
    : Pipeline(params), camera_(nullptr)
{
    ...
    vio_frontend_module_ = VIO::make_unique<VisionImuFrontendModule>(
        ...
        VisionImuFrontendFactory::createFrontend(
            ...
            gtsam::imuBias::ConstantBias(), params.frontend_params_, camera_,
    ...
    LOG_IF(FATAL, params.backend_params_->addBetweenStereoFactors_)
        << "addBetweenStereoFactors is set to true, but this is a mono "
           "pipeline!";
    ...
    vio_backend_module_ = VIO::make_unique<VioBackendModule>(
        ...
        BackendFactory::createBackend(
            ...
            camera_->getBodyPoseCam(), stereo_cam->getStereoCalib(),
            *backend_params_, imu_params_, backend_output_params,
            FLAGS_log_output));
    ...
    if (FLAGS_use_lcd) {
        lcd_module_ = VIO::make_unique<LcdModule>(
            ...
            LcdFactory::createLcd(
                LoopClosureDetectorType::BoW, params.lcd_params_, stereo_cam,
