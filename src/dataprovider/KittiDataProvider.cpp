...
KittiDataProvider::KittiDataProvider() : DataProviderInterface(), kitti_data_()
{
    // Parse Kitti dataset.
                                  ...
                                  cv::Mat&           T) const
{
    ...
    std::string   calibration_file_path =
        input_dataset_path + calibration_filename;
    calib_file.open(calibration_file_path.c_str());
    // Read calibration file
    CHECK(calib_file.is_open())
        << "Could not open calibration files located at: "
