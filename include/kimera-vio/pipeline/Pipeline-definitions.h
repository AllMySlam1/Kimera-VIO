...
struct VioParams : public PipelineParams
{
     ...
     * @param params_folder_path if left empty ("") no params will be parsed,
     * and it returns default values for all parameters. If a path is passed,
     * then it will parse the params from inside the given folder path. It
     * assumes the following system layout inside params_folder_path.
     *
     ...
     * └── DisplayParams.yaml
     *
     * NOTE: If you wish to parse filenames different than the ones above, you
     * can always use the ctor below.
     */
     ...
     * ```
     * where folder_path is the path to the folder containing all the YAML
     * params, and vio_params is an instance of this class.
     *
     * @param params_folder_path A path to the folder containing YAML files
     * below.
