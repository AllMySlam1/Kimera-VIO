  ...
  public:
    ...
    BackendInput(
        ...
        : PipelinePayload(timestamp_kf_nsec),
          ...
          stereo_tracking_status_(stereo_tracking_status), pim_(pim),
...
struct BackendOutput : public PipelinePayload
{
    ...
    BackendOutput(const Timestamp&                   timestamp_kf,
        ...
        : PipelinePayload(timestamp_kf),
          ...
          state_(state), state_covariance_lkf_(state_covariance_lkf),
          factor_graph_(factor_graph), cur_kf_id_(cur_kf_id),
          landmark_count_(landmark_count), debug_info_(debug_info),
    ...
    BackendOutput(const VioNavStateTimestamped&      vio_navstate_timestamped,
        ...
        : PipelinePayload(vio_navstate_timestamped.timestamp_),
          W_State_Blkf_(vio_navstate_timestamped), state_(state),
