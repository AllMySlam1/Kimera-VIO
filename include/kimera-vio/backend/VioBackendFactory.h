...
class BackendFactory {
  public:
    ...
    static VioBackend::UniquePtr
    createBackend(const BackendType&         backend_type,
        ...
        switch (backend_type) {
            case BackendType::kStereoImu: {
                return VIO::make_unique<VioBackend>(
                    B_Pose_leftCam, stereo_calibration, backend_params,
                    imu_params, backend_output_params, log_output);
            }
