...
static void
getValidKeypointsFromStatusKeypointsCV(const StatusKeypointsCV& status_kpts_cv,
...
template <class Base, class Derived> inline Derived safeCast(const Base& base)
{
    try {
