  ...
  public:
    VisualInertialFrame(const gtsam::Pose3&    curr_body_pose,
        ...
        : b0_R_bk_(prev_body_pose.rotation().matrix()),
          ...
          dbg_Jacobian_dR_(dbg_Jacobian_dR), cam_dt_(cam_dt), pim_dt_(pim_dt),
          dt_bk_(0.5 * (cam_dt + pim_dt)){};  // TODO(Toni): remove hardcoded.

    ~VisualInertialFrame() = default;

  public:
    inline double camDt() const
    {
        return cam_dt_;
    }
    inline double pimDt() const
    {
        return pim_dt_;
    }
    inline double dtBk() const
    {
        return dt_bk_;
    }
    inline gtsam::Matrix3 b0Rbkp1() const
    {
        return b0_R_bkp1_;
    }
    inline gtsam::Matrix3 b0Rbk() const
    {
        return b0_R_bk_;
    }
    inline gtsam::Vector3 b0Pbkp1() const
    {
        return b0_p_bkp1_;
    }
    inline gtsam::Vector3 b0Pbk() const
    {
        return b0_p_bk_;
    }
    gtsam::Matrix3 bkRbkp1() const
    {
        return (b0_R_bk_.transpose() * b0_R_bkp1_);
    }
    gtsam::Vector3 bkPbkp1() const
    {
        return (b0_p_bkp1_ - b0_p_bk_);
    }
    inline gtsam::Matrix3 bkGammaBkp1() const
    {
        return bk_gamma_bkp1_;
    }
    inline gtsam::Vector3 bkAlphaBkp1() const
    {
        return bk_alpha_bkp1_;
    }
    inline gtsam::Vector3 bkBetaBkp1() const
    {
        return bk_beta_bkp1_;
    }
    inline gtsam::Matrix3 dbgJacobianDr() const
    {
        return dbg_Jacobian_dR_;
    }
    gtsam::Matrix3 A11() const
    {
        return (-dt_bk_ * b0_R_bk_.transpose());
    }
    ...
    gtsam::Matrix3 A21() const
    {
        return (-b0_R_bk_.transpose());
    }
    gtsam::Matrix3 A22() const
    {
        return b0_R_bk_.transpose();
    }
    gtsam::Matrix3 A23() const
    {
        return (dt_bk_ * b0_R_bk_.transpose());
    }
    inline gtsam::Vector3 b2() const
    {
        return bk_beta_bkp1_;
    }
