...
class InitializationBackend : public VioBackend {
  public:
    ...
    typedef ThreadsafeQueue<InitializationInputPayload::UniquePtr>::
        InternalQueue InitializationQueue;
    /* ------------------------------------------------------------------------
     */
  ...
  public:
    ...
    bool
    bundleAdjustmentAndGravityAlignment(InitializationQueue& output_frontend,
