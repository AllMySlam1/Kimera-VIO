...
class OpenCv3dDisplay : public DisplayBase {
  public:
     ...
     * Displaying must be done in the main thread, that it is why it is
     * separated from Visualizer3D (plus it makes everything faster as
     * displaying and building 3D graphics is decoupled).
     * @param viz_output
     */
  ...
  private:
    ...
    safeDisplayInputCast(DisplayInputBase::UniquePtr display_input_base);
