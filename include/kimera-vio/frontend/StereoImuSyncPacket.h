...
struct ReinitPacket
{
    ReinitPacket(const bool&           reinit_flag_ext = false,
        ...
        : reinit_flag_ext_(reinit_flag_ext), timestamp_ext_(timestamp_ext),
          W_Pose_Bext_(W_Pose_Bext), W_Vel_Bext_(W_Vel_Bext),
  ...
  public:
    ...
    {
        return reinit_flag_ext_;
    }
    inline const Timestamp& getReinitTime() const
    {
        return timestamp_ext_;
    }
    inline const gtsam::Pose3& getReinitPose() const
    {
        return W_Pose_Bext_;
    }
    inline const gtsam::Vector3& getReinitVel() const
    {
        return W_Vel_Bext_;
    }
    inline const ImuBias& getReinitBias() const
    {
        return imu_bias_ext_;
    }
...
class StereoImuSyncPacket : public FrontendInputPacketBase {
  public:
    ...
    // Careful, returning references to members can lead to dangling refs.
    inline const StereoFrame& getStereoFrame() const
    {
    ...
    inline const ReinitPacket& getReinitPacket() const
    {
        return reinit_packet_;
    }
    inline const bool getReinitFlag() const
    {
