...
class MesherFixture : public ::testing::Test {
  public:
    MesherFixture()
        : img_(), img_name_(), frame_(nullptr), camera_params(),
          mesher_params_(), mesher_(nullptr)
    {
        ...
        mesher_params_ = MesherParams(camera_params.body_Pose_cam_,
                                      camera_params.image_size_);
